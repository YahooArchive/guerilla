...
logger.d("config.js: process is pid " + process.pid);
logger.d("config.js: process.env.USER =" + process.env.USER)
logger.d("config.js process.argv:");
...
function Config() {
    ...
    if (this.mode === 'worker') {
        ...
        logger.i("data_dir=" + this.data_dir);

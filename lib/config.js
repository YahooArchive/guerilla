...
function getPathArray(mode) {
    ...
    var aPathArray = [__rootdir, 'config', mode, 'config.json'];
    logger.i('The config file is from the default location:' + path.join.apply(null,aPathArray));
    return aPathArray;
}

function getConfig(mode) {
    return require(path.join.apply(null, getPathArray(mode)));
}

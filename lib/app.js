...
app.use(function (req, res, next) {
	...
	res.locals.mode = utilities.getMode();
...
//set up routes
var routes = fs.readdirSync(path.join(__rootdir, 'routes', utilities.getMode()));
routes.forEach(function (file) {
    if (file !== '.DS_Store')
        app.use('/', require(path.join(__rootdir, 'routes', utilities.getMode(), file)));
});
